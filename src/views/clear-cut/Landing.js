    ...
    <div className="App">
      ...
      <div className='App-body'>
        ...
        <p>
          ...
          If you're a developer and would like to play around with the package, you can install via <a href="https://pypi.org/project/clear-cut/"> https://pypi.org/project/clear-cut/ </a>.
        </p>
        <h3>Usage</h3>
        <p>
